...
//    private static final Logger LOGGER = LoggerFactory.getLogger(GameControllerBU.class);
//
//    @Autowired
...
//    public String home(final Model model, final HttpSession session) throws IOException {
//
...
//    public String guessWord(final HttpServletRequest request) throws IOException {
